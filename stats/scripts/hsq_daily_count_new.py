...
def get_daily_fin_data(cnx, start, end, daily_data):
    ...
    platforms_condition = {
        'group_app': ' and o.source=0 and o.device_type in (0,1,2)'
                     ' and pin_status=2 and so.status in (2,3,9)',
...
def get_daily_user_data(cnx, start, end, daily_data):
    ...
    platforms_condition = {
        'group_app': ' and source in (-1,0) and pin_status=2 '
                     ' and device_type in (0,1,2)',
        'group_wx': ' and source in (-1,0) and pin_status=2 and device_type=3',
        'jx': ' and source=2 ',
